 ...
 */
export function fixListOfWagons([a, b, ...ids]) {
  return [...ids, a, b];
}
 ...
 */
export function correctListOfWagons([a, ...ids], missing) {
  return [a, ...missing, ...ids];
}
 ...
 */
export function extendRouteInformation({...info}, {...extra}) {
  return {...info, ...extra};
}
