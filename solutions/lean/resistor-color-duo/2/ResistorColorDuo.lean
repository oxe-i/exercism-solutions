/-
  The solution in this comment evaluates the macro defined in `Extra.lean` using an elaborator.
...
macro_rules
  | `(*[[ $vals,* ]]) => do
    match vals.getElems.take 2 with
    | #[a₁, a₂] =>
      match getValue a₁, getValue a₂ with
      | some v₁, some v₂ => return Syntax.mkNatLit (10 * v₁ + v₂)
