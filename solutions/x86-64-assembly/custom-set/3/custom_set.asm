...
; And to keep track of used indexes in the array, there's a used_sets array with 255 booleans
;
...
set_subset:
    ...
    vmovupd ymm1, [r10]
    vandpd ymm1, ymm1, [r11]
    vpcmpeqd ymm0, ymm1, [r10]
    vphaddd ymm0, ymm0, ymm0
    vphaddd ymm0, ymm0, ymm0
    vphaddd ymm0, ymm0, ymm0
    vmovq rax, xmm0
