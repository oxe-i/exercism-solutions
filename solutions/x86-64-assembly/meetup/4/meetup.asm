...
meetup:
    ...
    movzx r9d, word [r11 + digits + 2*rdx]
    mov dword [rdi], r9d
    ...
    movzx r9d, word [r11 + digits + 2*rsi]
    or r9d, ('-' << 16)
    mov dword [rdi + 2], r9d
    ...
    cmp r10d, 3
    sbb rdx, 0
    movzx eax, byte [r11 + sakamoto + rdx]
    add eax, dword [r11 + 4*r10 - 4]
    
    movzx esi, word [r11 + digits + 2*r10]
    or esi, ('-' << 16)
    mov dword [rdi + 5], esi
    ...
    add eax, r9d
    sub eax, r8d
    movzx eax, byte [r11 + mod7 + rax]
    sub r9d, eax

    movzx edx, word [r11 + digits + 2*r9]
